pipeline {
    ...
    stages {
        ...
        // stage('Build Images') {
        //     steps {
        //         sh 'docker build -t vaibhavatosm22/fullstackapp:frontend-latest frontend'
        //         sh 'docker build -t vaibhavatosm22/fullstackapp:backend-latest backend'
        //     }
        // }
        ...
        //             sh 'docker push vaibhavatosm22/fullstackapp:frontend-latest'
        //             sh 'docker push vaibhavatosm22/fullstackapp:backend-latest'
        //         }
        //     }
        // }
    }
